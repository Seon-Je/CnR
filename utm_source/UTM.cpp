...
int main(void)
{
	double lat1 = 35.246785;
	double lon1 = 126.837075;

	double utm_x1 = 0;
	double utm_y1 = 0;

	double lat2 = 35.245350;
	double lon2 = 126.834666;

	double utm_x2 = 0;
	double utm_y2 = 0;

	double lat3 = 35.244795;
	double lon3 = 126.835605;

	double utm_x3 = 0;
	double utm_y3 = 0;

	double lat4 = 35.243976;
	double lon4 = 126.836437;

	double utm_x4 = 0;
	double utm_y4 = 0;

	double lat5 = 35.242301;
	double lon5 = 126.834071;

	double utm_x5 = 0;
	double utm_y5 = 0;

	int zone = 52;
	LatLonToUTMXY(lat1,lon1,zone,utm_x1,utm_y1);
	LatLonToUTMXY(lat2,lon2,zone,utm_x2,utm_y2);
	LatLonToUTMXY(lat3,lon3,zone,utm_x3,utm_y3);
	LatLonToUTMXY(lat4,lon4,zone,utm_x4,utm_y4);
	LatLonToUTMXY(lat5,lon5,zone,utm_x5,utm_y5);
